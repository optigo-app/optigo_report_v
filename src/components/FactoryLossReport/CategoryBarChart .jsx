  ...
  return (
    <>
      ...
      <Box sx={{ flex: 1, overflowY: "auto" }}>
        <Box sx={{ height: formattedData.length * 40, width: "100%", }}>
          <ResponsiveContainer width="100%" height="95%">
            ...
            <defs>
                ...
                <linearGradient id={redGradientId} x1="0" y1="0" x2="1" y2="0">
                  <stop offset="0%" stopColor="rgb(221, 118, 118)" stopOpacity={0.9} />
                  <stop offset="100%" stopColor="rgb(245, 83, 83)" stopOpacity={1} />
